...
if __name__ == '__main__':
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_ordinal, y_ordinal, random_state=1)
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_numeric, y_numeric, random_state=1)
